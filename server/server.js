...
app.post('/add', (req, res) => {
  ...
  let sql = 'INSERT INTO new_schema.npcs (name, level, title, class, race, age, currentHP, Lv1_HP, Lv2_HP, Lv3_HP, Lv4_HP, Lv5_HP, \
    ...
    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
  db.query(sql, [req.body.name, req.body.level, req.body.title, req.body.npcClass, req.body.race, req.body.age, req.body.currentHP,
  ...
  req.body.str, req.body.ex_str, req.body.int, req.body.dex, req.body.con, req.body.wis, req.body.cha, req.body.memorized,
...
app.put('/update', (req, res) => {
  ...
  let sql = 'UPDATE new_schema.npcs SET level=?, title=?, class=?, race=?, age=?, currentHP=?, status=?,\
  ...
  notes=? WHERE name=?';
  db.query(sql, [req.body.level, req.body.title, req.body.npcClass, req.body.race, req.body.age, req.body.currentHP,
  req.body.status, req.body.str, req.body.ex_str, req.body.int, req.body.dex, req.body.con,
