...
app.put('/update', (req, res) => {
  ...
  let sql = 'UPDATE new_schema.npcs SET level=?, title=?, class=?, race=?, age=?, gender=?, currentHP=?, status=?,\
  ...
  req.body.currentHP, req.body.status, req.body.str, req.body.ex_str, req.body.int, req.body.dex, req.body.con,
