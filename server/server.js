...
app.post('/add', (req, res) => {
  ...
  let sql = 'INSERT INTO new_schema.npcs (name, level, title, class, race, currentHP, Lv1_HP, Lv2_HP, Lv3_HP, Lv4_HP, Lv5_HP, \
    ...
    status, ac, thac0, str, ex_str, intel, dex, con, wis, cha, memorized, SBLvl_1, SBLvl_2, SBLvl_3, SBLvl_4, SBLvl_5, SBLvl_6, \
  ...
  req.body.ac, req.body.thac0, req.body.str, req.body.ex_str, req.body.int, req.body.dex, req.body.con, req.body.wis,
